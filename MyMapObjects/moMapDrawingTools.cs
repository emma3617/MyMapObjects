...
namespace MyMapObjects
{
    ...
    // internal:仅程序内部使用，禁止外部访问
    // static:不能实例化成员，不能声明变量，可以声明常量
    {
        #region 程序集方法
        ...
        /// 绘制几何图形
        /// </summary>
        /// <param name="g">要绘制的窗体</param>
        /// <param name="extent">绘制范围</param>
        /// <param name="mapScale">比例尺（的倒数）</param>
        /// <param name="dpm">分辨率，每米多少个像素</param>
        /// <param name="mpu">一个单位等于多少米</param>
        /// <param name="geometry">待绘制的几何图形</param>
