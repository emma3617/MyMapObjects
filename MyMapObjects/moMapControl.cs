...
namespace MyMapObjects
{
    public partial class moMapControl :UserControl
    {
        ...
        private Bitmap mBufferMap2 = new Bitmap(10, 10); //缓冲位图，含所有要素、注记和跟踪图形（选择图形、描绘图形等）
        ...
        /// 获取或设置选择闪烁要素的颜色
        /// </summary>
        [Browsable(true), Description("获取或设置选择闪烁要素的颜色")]
        ...
        /// <summary>
        /// 地图比例尺发生变化
        /// 类似PictureBox的Paint事件
        /// </summary>
        [Browsable(true),Description("地图比例尺发生变化")]
